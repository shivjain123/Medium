...
figure = pff.create_distplot([claps], ["Results"], show_hist = False)

#figure.show()

population_mean = s.mean(claps)
population_sd = s.stdev(claps)
...
def random_set_of_mean(counter):
    ...
    for d in range(counter):
        random_i = r.randint(0, len(claps) - 1)
        data_set.append(claps[random_i])
